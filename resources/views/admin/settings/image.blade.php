...
<div class="layoutContent">
    <div class="container-fluid profile">
        <div class="row show-header">
            <div class="col-sm-12">
                <h1>
                    <i class="fas fa-home fa-xs"></i> <span>Meta Image</span>
                </h1>
            </div>
        </div>
            ...
            <div class="col-sm-12 col-md-12">
                <div class="card shadow">
                    <div class="card-header">
                        <span>
                            Imagen por default al compartir URL en Redes
                        </span>
                    </div>
                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-sm-12">
                          ...
                          <div class="input-group">
                            ...
                            {!! Form::text('meta_image', null, ['class' => 'form-control', 'id' => 'thumbnail0']) !!}
                          </div>
                          <div id="holder0" style="margin-top:15px;max-height:100px;">
                            <img src="{{ $setting->meta_image }}" alt="" style="height:3rem">
                          </div>
                        </div>
