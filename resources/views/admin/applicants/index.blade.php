            ...
            <div class="col-sm-12">
                <div class="card shadow">
                    <div class="card-header">
                        ...
                        <!--<a class="btn btn-success" href="{{ route('applicants.create') }}">
                            <span class="icon">
                    ...
                    <table class="table tableD">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->email }}</td>
                                <td><a href="{{ asset('cvs/'.$item->file) }}" target="_blank">Ver CV</a></td>
                                <td>{{ $item->job->name }}</td>
                                <td>
                ...
                <div class="paginacionTotal d-flex justify-content-end">
                    {{ $applicants->withQueryString()->render() }}
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-center">
            ...
            {!! Form::open(['route' => ['applicants.destroy', ''], 'method' => 'DELETE', 'id' => 'form-eliminar']) !!}
...
$('document').ready(function(){
    $('.btn-eliminar').click(function(e){
        ...
        var base = '{{ route('applicants.destroy', '') }}';
        var url = base + '/' +id;
