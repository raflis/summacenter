    ...
    <div class="container-fluid">
        <div class="row layout-header">
            <div class="col-sm-12 header-content">
                <h1>
                    <i class="fas fa-cloud-download-alt fa-xs text-white2"></i> Registros - Formulario de Contacto
                </h1>
            </div>
        </div>
                ...
                <div class="card shadow">
                    <div class="card-header">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="">
                                <a class="btn btn-success btn-descargar" href="{{ route('excel.contact', ['name' => request('name'), 'lastname' => request('lastname'), 'start_date' => request('start_date'), 'end_date' => request('end_date')]) }}">
                                    <span class="icon">
                    ...
                    <div class="card-body">
                        <div class="buscar-descarga">
                            <form action="{{ route('records.contact') }}" method="GET" class="row" style="width:100%">
