...
@include('admin.projects.partials.slider')
@include('admin.projects.partials.ubicacion')
@include('admin.projects.partials.espacio')
@include('admin.projects.partials.plano')
