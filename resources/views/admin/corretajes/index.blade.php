    ...
    <div class="container-fluid">
        <div class="row layout-header">
            <div class="col-sm-12 header-content">
                <h1>
                    <i class="fas fa-bullhorn fa-xs text-white2"></i> Corretajes
                </h1>
                <span class="subtitle">
                    Crear, editar y eliminar corretajes.
                </span>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card shadow">
                    <div class="card-header">
                        ...
                        <a class="btn btn-success" href="{{ route('corretajes.create') }}">
                            <span class="icon">
                    ...
                    <table class="table tableD">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ $project->image_index }}" alt="" height=50></td>
                                <td>{{ $project->name }}</td>
                                <td>{{ $project->description_index }}</td>
                                <td>{{ $project->order }}</td>
                                <td>{{ getStatus($project->status) }}</td>
                                <td>
                                    <div style="display: inline-flex">
                                        <a class="btn btn-primary text-white btn-sm mr-1" href="{{ route('corretajes.edit', $project->id) }}">
                                            <i class="far fa-edit pr-1"></i> Editar
                                        </a>
                                        <a class="btn btn-danger btn-sm btn-eliminar" href="" ideliminar="{{ $project->id }}"><i class="far fa-trash-alt pr-1"></i> Eliminar</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
                ...
                <div class="paginacionTotal d-flex justify-content-end">
                    {{ $projects->withQueryString()->render() }}
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-center">
            ...
            {!! Form::open(['route' => ['corretajes.destroy', ''], 'method' => 'DELETE', 'id' => 'form-eliminar']) !!}
...
$('document').ready(function(){
    $('.btn-eliminar').click(function(e){
        ...
        var base = '{{ route('corretajes.destroy', '') }}';
        var url = base + '/' +id;
