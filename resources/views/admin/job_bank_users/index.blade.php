            ...
            <div class="col-sm-12">
                <div class="card shadow">
                    <div class="card-header">
                        ...
                        <!--<a class="btn btn-success" href="{{ route('job_bank_users.create') }}">
                            <span class="icon">
                    ...
                    <table class="table tableD">
                        <thead>
                            <tr>
                                ...
                                <th>Carrera univ.</th>
                                <th>Puesto actual</th>
                                <th># de postulaciones</th>
                                <th>Mostrar</th>
                                <th>Acciones</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($job_bank_users as $item)
                            <tr>
                                <td>{{ $job_bank_users->firstItem() + $loop->index }}</td>
                                <td>{{ $item->email }}</td>
                                ...
                                <td>
                                    <div style="display: inline-flex">
                                        <a class="btn btn-primary text-white btn-sm mr-1" href="{{ route('job_bank_users.edit', $item->id) }}">
                ...
                <div class="paginacionTotal d-flex justify-content-end">
                    {{ $job_bank_users->withQueryString()->render() }}
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-center">
            ...
            {!! Form::open(['route' => ['job_bank_users.destroy', ''], 'method' => 'DELETE', 'id' => 'form-eliminar']) !!}
...
$('document').ready(function(){
    $('.btn-eliminar').click(function(e){
        ...
        var base = '{{ route('job_bank_users.destroy', '') }}';
        var url = base + '/' +id;
