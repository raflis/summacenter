    ...
    <div class="container-fluid">
        <div class="row layout-header">
            <div class="col-sm-12 header-content">
                <h1>
                    <i class="fas fa-bullhorn fa-xs text-white2"></i> Insignias - {{ $course_area->name }}
                </h1>
                <span class="subtitle">
                    Crear, editar y eliminar insignias.
                </span>
            </div>
        </div>
                ...
                <div class="card shadow">
                    <div class="card-header">
                        ...
                        <div>
                            ...
                            <a class="btn btn-success" href="{{ route('badges.create', ['id_get' => Request::get('id_get')]) }}">
                                <span class="icon">
                    ...
                    <table class="table tableD">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ $item->image }}" alt="" height=30></td>
                                <td>{{ $item->name }}</td>
                                <td>{{ getBadge($item->category, NULL) }}</td>
                                <td>{{ $item->course_area->name }}</td>
                                <td>{{ $item->order }}</td>
                                <td>
                                    <div style="display: inline-flex">
                                        <a class="btn btn-primary text-white btn-sm mr-1" href="{{ route('badges.edit', [$item->id, 'id_get' => Request::get('id_get')]) }}">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-center">
            ...
            {!! Form::open(['route' => ['badges.destroy', ''], 'method' => 'DELETE', 'id' => 'form-eliminar']) !!}
