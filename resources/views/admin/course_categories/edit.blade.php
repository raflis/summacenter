    ...
    <div class="container-fluid">
        ...
        <div class="row layout-body">
            <div class="col-sm-12">
                <div class="card shadow">
                    ...
                    <div class="card-body row">
                        ...
                        @include('admin.course_categories.partials.form')
                    </div>
                </div>
            </div>
            <div class="col-sm-12 my-4">
                ...
                <a class="btn btn-danger py-2 px-3" href="{{ route('course_categories.index', ['id_get' => Request::get('id_get'), 'name_get' => Request::get('name_get')]) }}">Atrás</a>
                {!! Form::close() !!}
            </div>
        </div>
