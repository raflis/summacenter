        ...
        <div class="row layout-body">
            <div class="col-sm-12">
                <div class="card shadow">
                    <div class="card-header">
                        ...
                        <div>
                            ...
                            <a class="btn btn-success" href="{{ route('blog_posts.create', ['id_get' => Request::get('id_get')]) }}">
                                <span class="icon">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: inline-flex">
                                        <a class="btn btn-primary text-white btn-sm mr-1" href="{{ route('blog_posts.edit', [$item->id, 'id_get' => Request::get('id_get')]) }}">
                ...
                <div class="paginacionTotal d-flex justify-content-end">
                    {{ $blog_posts->withQueryString()->render() }}
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-center">
            ...
            {!! Form::open(['route' => ['blog_posts.destroy', ''], 'method' => 'DELETE', 'id' => 'form-eliminar']) !!}
...
$('document').ready(function(){
    $('.btn-eliminar').click(function(e){
        ...
        var base = '{{ route('blog_posts.destroy', '') }}';
        var url = base + '/' +id;
