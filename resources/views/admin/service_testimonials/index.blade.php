    ...
    <div class="container-fluid">
        <div class="row layout-header">
            <div class="col-sm-12 header-content">
                <h1>
                    <i class="fas fa-bullhorn fa-xs text-white2"></i> Testimonios de Servicios
                </h1>
                <span class="subtitle">
            ...
            <div class="col-sm-12">
                <div class="card shadow">
                    <div class="card-header">
                        ...
                        <a class="btn btn-success" href="{{ route('servicestestimonials.create') }}">
                            <span class="icon">
                ...
                <div class="tablaTotal">
                    <table class="table tableD">
                        ...
                        <tbody>
                            @foreach ($servicestestimonials as $testimonial)
                            <tr>
                                <td>{{ $servicestestimonials->firstItem() + $loop->index }}</td>
                                <td>{{ $testimonial->name }}</td>
                                <td>{{ $testimonial->short_phrase }}</td>
                                <td>{{ $testimonial->order }}</td>
                                <td>
                                    <div style="display: inline-flex">
                                        <a class="btn btn-primary text-white btn-sm mr-1" href="{{ route('servicestestimonials.edit', $testimonial->id) }}">
                ...
                <div class="paginacionTotal d-flex justify-content-end">
                    {{ $servicestestimonials->withQueryString()->render() }}
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-center">
            ...
            {!! Form::open(['route' => ['servicestestimonials.destroy', ''], 'method' => 'DELETE', 'id' => 'form-eliminar']) !!}
...
$('document').ready(function(){
    $('.btn-eliminar').click(function(e){
        ...
        var base = '{{ route('servicestestimonials.destroy', '') }}';
        var url = base + '/' +id;
