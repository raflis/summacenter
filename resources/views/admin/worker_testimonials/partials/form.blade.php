...
<div class="form-group col-sm-12">
  {!! Form::label('image','Selecciona una imagen para desktop:',['class'=>'mt-3']) !!} <strong>(402 x 643px)</strong><code>*</code>
...
<div id="holder" style="margin-top:15px;max-height:100px;">
  @if (Route::currentRouteName()=="workerstestimonials.edit")
        <img src="{{ $workerstestimonials->image }}" alt="" style="height:5rem">
    @endif
</div>
</div>
