                ...
                Los detalles de tu pedido se muestran a continuación
                        ...
                        <tr>
                          ...
                          <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                              ...
                              <tr>
                                <td align="center">&nbsp;</td>
                                <td align="center"><img src="{{ asset('images/yape.png') }}" width="55" height="57" alt=""/></td>
                                <td>&nbsp;</td>
                                <td align="center"><img src="{{ asset('images/plin.png') }}" width="55" height="56" alt=""/></td>
                                <td>&nbsp;</td>
                                </tr>
                              <tr>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                <td align="center">&nbsp;</td>
                                <td align="center"><img src="{{ asset('images/qr.png') }}" width="170" height="170" alt=""/></td>
                                <td>&nbsp;</td>
                                <td align="center"><img src="{{ asset('images/qr.png') }}" width="170" height="170" alt=""/></td>
                                <td>&nbsp;</td>
                                </tr>
                        ...
                        <tr>
                          ...
                          <td colspan="2"><p style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size: 13px; color: #061d38; line-height: 20px; font-weight: normal; text-align: left; margin: 0;padding-left: 8px">
                                    Desde tu app Yape o Plin, escanea el QR y realiza el pago. Envíanos una captura de la operación a nuestro contacto oficial por el canal Whatsapp.
                                    </p></td>
                          <td>&nbsp;</td>
                          </tr>
                        <tr>
