    ...
    <div class="container-fluid content">
        <div class="row content_">
            <div class="col-md-11">
                <p class="gracias">
                    <strong>
                        Ocurrió un error en tu transacción
                    </strong>
                    <br>
                    Número de pedido: {{ $data_error['purchaseNumber'] }}
                    <br>
                    Fecha y hora de pedido: {{ \Carbon\Carbon::parse($data_error['transaction_date'])->format('d/m/Y H:i:s') }}
                    <br>
                    Detalle: {{ $data_error['detail'] }}
                    <br><br>
                    Summa Center
                </p>
            </div>
