        ...
        <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>
              ...
              <p style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size: 17px; color: #061d38; line-height: 20px; font-weight: bold; text-align: center; margin: 0">
          ...
          <tr>
            <td>
              <p style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size: 16px; color: #061d38; line-height: 20px; font-weight: regular; text-align: left; margin: 0">
                ...
                Hola {{ $name }}, sigue el enlace para poder restablecer tu contraseña
