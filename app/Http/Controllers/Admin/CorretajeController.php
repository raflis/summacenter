...
class CorretajeController extends Controller
{
    ...
    {
        $projects = Project::where('type', 'corretajes')->orderBy('order','Asc')->paginate();
        return view('admin.corretajes.index', compact('projects'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.corretajes.create', compact('districts', 'typeprojects','typeproperties', 'enviroments'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($validator->fails()):
            ...
            return redirect()->route('corretajes.index')->with('message','Creado con éxito.')->with('typealert','success');
        endif;
    }
    ...
    public function edit($id)
    {
        ...
        $typeproperties = TypeProperty::orderBy('name', 'Asc')->pluck('name', 'id');
        $enviroments= Enviroment::orderBy('name', 'ASC')->get();
        return view('admin.corretajes.edit', compact('project', 'districts', 'typeprojects','typeproperties', 'enviroments'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($validator->fails()):
            ...
            return redirect()->route('corretajes.index')->with('message','Actualizado con éxito.')->with('typealert','success');
        endif;
    }
